...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        //    if (isOverItem)
        //        GUI.Label(new Rect(0.0f, 0.0f, 100, 100), "按F交互");
        //    else
        //        GUI.Label(new Rect(0.0f, 0.0f, 100, 100), "");
        //}
        ...
        private void LateUpdate()
        {
            ...
            if (isOverItem)
            {
                if (Input.inputString.Contains("f") || Input.inputString.Contains("F"))
                {

                    if (obj_ != null)
                    {
                        (obj_ as GameObject).GetComponent<openDoor>().notifyinteractive();
                    }
                }
            }
            */
