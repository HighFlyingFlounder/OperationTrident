...
namespace OperationTrident.StartScene {
    public static class StartSceneEvent
    {
        public enum StartSceneState { Login, Title, RoomList, Team}

        public static StartSceneState startSceneState = StartSceneState.Login;
