...
public class MultiBattle : MonoBehaviour
{
    ...
    //游戏中给所有的角色
    //public Dictionary<string, PlayerController> list = new Dictionary<string, PlayerController>();
    ...
    public void GeneratePlayer(string id, int swopID)
    {
        ...
        // PlayerController bt = new PlayerController();
        // bt = playerObj.GetComponent<PlayerController>();
