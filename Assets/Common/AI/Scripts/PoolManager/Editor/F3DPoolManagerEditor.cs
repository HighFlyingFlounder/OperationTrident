...
public class F3DPoolManagerEditor : Editor
{
    ...
    private string assetPath = "Assets/Common/AI/Resources/AIWeaponPool/";
    ...
    void LoadDatabase()
    {
        F3DPoolManagerDB newManager = Resources.Load("AIWeaponPool/" + databaseName) as F3DPoolManagerDB;
        if (newManager != null)
        {
            database = newManager;
